...
Next, this time I want to further see if the diameter of plants with curbs are affected by season of plantation. For this, I want to extract months of plantation and see if the diameter in the trees differ with respect to month of plantation.
...
I have divided diameters into thin, medium and thick. I also divided the months of plantation into early and late.
...
I created a column with only the months of plantation extracted from the date (yy-mm-dd) This may be useful to see if the plantation month have roles in growth of trees. 
